...
========================================================= */
  function applyRules(card, copy, isPlayer) {
    ...
    if (card.number === 1) {
      pushAlert("🟡 HOLD ON");
      addLog("Hold On played", isPlayer ? "player" : "bot");
    }
    ...
    if (card.number === 14) {
      ...
      addLog("General Market triggered", isPlayer ? "player" : "bot");
    }
  }
